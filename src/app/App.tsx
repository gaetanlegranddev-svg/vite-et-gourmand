...
function ThemeBadge({ theme }: { theme: Theme }) { return <span className={`text-[10px] tracking-widest uppercase px-2 py-0.5 font-medium ${THEME_STYLES[theme]}`}>{ {"noel":"Noël","paques":"Pâques","classique":"Classique","evenement":"Événement"}[theme] || theme}</span>; }
